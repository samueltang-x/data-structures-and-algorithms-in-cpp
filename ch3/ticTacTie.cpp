...
void putMark(int i, int j) /* throw(RuntimeException) */ {
  if (board[i][j] != EMPTY) {
    cout << "board[" << i << "][" << j << "] is already put." << endl;
    throw RuntimeException("board cell is already put");
  }
